...
def home():
    ...
    <head>
        ...
        <style>
            ...
            .product-img { width: 100%; height: 120px; object-fit: cover; border-radius: 6px; background-color: #eee; }
    ...
    <body>
            ...
            <div id="customerView" class="panel-box active">
                ...
                <div class="products-grid">
                    ...
                    <div class="product-card" onclick="openProductModal('{{ product.title }}', '{{ product.price }}', '{{ product.image }}', '{{ product.details }}', '{{ product.sizes }}', '{{ product.merchant_phone }}', '{% if product.show_name == 1 %}{{ product.merchant_name }}{% else %}تاجر مجهول{% endif %}')">
                        <img src="{{ product.image }}" class="product-img" onerror="this.onerror=null;this.src='https://images.unsplash.com/photo-1541014741259-df5290bc008c?w=400';">
        ...
        <div id="productModal" class="modal" onclick="closeProductModal()">
            <div class="modal-content" onclick="event.stopPropagation()">
                ...
                <img id="modalImg" src="" style="width:100%; height:180px; object-fit:cover; border-radius:8px;" onerror="this.onerror=null;this.src='https://images.unsplash.com/photo-1541014741259-df5290bc008c?w=400';">
